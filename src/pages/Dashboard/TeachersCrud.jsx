    ...
    <form onSubmit={handleAddTeachaer} autoComplete="off" className="p-5">
      ...
      <div className="flex justify-evenly mt-10">
        ...
        <div className="w-[40%] flex flex-col gap-3">
            <FilterCustom API={"/stacks"} filterId={stackId} setFilterId={setStackId} setFilterName={setStack} placeholder={'Stack tanlang'} extraClass={'!w-full'} />
            ...
            <Select placeholder={'Jins tanlang'} optionFilterProp="label" options={[{ label: "Erkak", value: "Erkak" }, { label: "Ayol", value: "Ayol" }]} />
            ...
            <FilterCustom API={"/works"} filterId={workCompanyId} setFilterId={setWorkCompanyId} setFilterName={setWorkCompany} placeholder={'Ish joyinggizni tanlang'} extraClass={'!w-full'} mode={'multiple'} />
        </div>
      </div>
    </form>
  )
